...
export const qaList = [
  ...
  // ------------------- FAQ -------------------
  {
    ...
    response:
      "이담 건축은 철골 구조, 목조 주택, 상가, 판넬 시공, 내부 인테리어 등 다양한 건축 경험을 바탕으로 주거용과 상업용 건축을 모두 진행합니다. 규모와 용도에 맞는 최적의 방식으로 시공을 제안드립니다.",
  },
  {
    key: "faq-시공지역",
    patterns: ["시공지역", "가능한지역", "어디까지"],
    response:
      "이담 건축은 동두천을 기반으로 경기 북부 지역을 중심으로 시공을 진행하고 있습니다. 전국 시공은 원칙적으로 하지 않으며, 지역 밀착형 시공을 통해 세심하고 책임감 있는 관리에 집중합니다.",
  },
  {
    key: "faq-상담무료",
